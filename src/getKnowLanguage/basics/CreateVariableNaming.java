...
public class CreateVariableNaming {
	 ...
	 *  "일반적인 필드"(로컬 변수 및 매개변수 제외)에 대해 이야기하는 경우 간단히 "필드"라고 말할 수 있습니다. 논의가 "위의 모든 것"에 적용된다면, 우리는 단순히 "변수"라고 말할 수 있습니다. 문맥상 구별이 필요한 경우 특정 용어(정적 필드, 지역 변수 등)를 적절하게 사용합니다. 또한 때때로 "회원"이라는 용어도 사용되는 것을 볼 수 있습니다. 유형의 필드, 메소드 및 중첩 유형을 집합적으로 해당 멤버 라고 합니다 .
	 */
}
